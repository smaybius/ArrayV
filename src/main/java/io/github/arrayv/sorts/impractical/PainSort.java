...
public final class PainSort extends BogoSorting {

    public PainSort(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        this.setSortListName("Pain Sort");
        this.setRunAllSortsName("Pain Sort");
        this.setRunSortName("Pain-Sort");
