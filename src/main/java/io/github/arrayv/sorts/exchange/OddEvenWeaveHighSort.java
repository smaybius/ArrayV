...
*/
final public class OddEvenWeaveHighSort extends Sort {
    public OddEvenWeaveHighSort(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        this.setSortListName("Odd-Even Weave (High Prime)");
        this.setRunAllSortsName("Odd-Even Weave Sort (High Prime)");
        this.setRunSortName("Odd-Even Weave (High Prime)");
        ...
        while (!testpass) {
            ...
            if (gap == 1) {
                ...
                while (boundi < currentLength && testpass) {
                    ...
                    Delays.sleep(0.25);
                    if (Reads.compareIndices(array, boundi - 1, boundi, 0.5, true) <= 0)
                        boundi++;
                    else {
                        testpass = false;
                        lastbound = boundi;
