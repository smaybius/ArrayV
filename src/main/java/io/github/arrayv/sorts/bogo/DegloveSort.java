...
*/
public final class DegloveSort extends BogoSorting {

    int min;
    int max;

    public DegloveSort(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        this.setSortListName("Deglove");
        this.setRunAllSortsName("Deglove Sort");
        this.setRunSortName("Deglovesort");
    ...
    protected void handleItems(int[] array, int currentLength) {
        ...
        Writes.write(array, j, randInt(min, max + 1), delay, true, false);
    }
