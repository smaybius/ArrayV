...
*/
public final class MaxGoofSort extends BogoSorting {

    int min;

    public MaxGoofSort(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);
        this.setSortListName("Max Goof");
        this.setRunAllSortsName("Max Goof Sort");
        this.setRunSortName("Max Goofsort");
