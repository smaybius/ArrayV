...
@SortMeta(name = "Tim", category = "Hybrid Sorts", question = "Enter the minimum run length (0: variable)", defaultAnswer = 0)
public class TimSort extends Sort {
    ...
    public void runSort(int[] array, int currentLength, int bucketCount) {
        ...
        TimSorting.sort(this.timSortInstance, array, currentLength, bucketCount);
    }
}
