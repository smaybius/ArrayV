...
public abstract class ShellSorting extends Sort {
    ...
    protected void shellSort(int[] array, int length, int bucketCount) {
        ...
        switch (bucketCount) {
            case 1:
                ...
                break;
            case 2:
                incs = PowTwoPlusOneGaps;
                break;
            case 3:
                incs = PowTwoMinusOneGaps;
                break;
            case 4:
                incs = ThreeSmoothGaps;
                break;
            case 5:
                incs = PowersOfThreeGaps;
                break;
            case 6:
                incs = SedgewickIncerpiGaps;
                break;
            case 7:
                incs = SedgewickGaps;
                break;
            case 8:
                incs = OddEvenSedgewickGaps;
                break;
            case 9:
                incs = GonnetBaezaYatesGaps;
                break;
            case 10:
                incs = TokudaGaps;
                break;
