...
public final class Calcium58Sort extends Sort {
    public Calcium58Sort(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);

        this.setSortListName("Calcium-58");
