...
SortPrompt.setSortThreadForCategory('Selection Sorts', 32) {
    ...
    run MultiSelectionSort go 128.numbers, 0.2.speed
    run ImprovedMultiSelectionSort go 128.numbers, 0.2.speed
    run RankSort go 128.numbers
    run CycleSort go 128.numbers, 0.01.speed
    run StableCycleSort go 128.numbers, 0.1.speed
    ...
    run TriangularHeapSort go 2048.numbers, 3.speed
    run FibonacciHeapSort go 512.numbers, 1.5.speed
    run PureFibHeapSort go 512.numbers, 1.5.speed
    run WeakHeapSort go 2048.numbers, 1.5.speed
    run TernaryHeapSort go 2048.numbers, 1.5.speed
    run GeapSort go 128.numbers
    run HeapHunterSort go 1024.numbers, 1.5.speed
    run ScrollHeapHunterSort go 1024.numbers, 1.5.speed
    run BinomialHeapSort go 1024.numbers, 1.5.speed
    run SmoothSort go 2048.numbers
    run BinomialSmoothSort go 1024.numbers, 1.5.speed
