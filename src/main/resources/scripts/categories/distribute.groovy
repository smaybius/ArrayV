...
SortPrompt.setSortThreadForCategory('Distribution Sorts', 21) {
    ...
    run RotateLSDRadixSort go 1024.numbers, 4.buckets, 0.5.speed
    run RotateMSDRadixSort go 1024.numbers, 4.buckets, 0.5.speed
